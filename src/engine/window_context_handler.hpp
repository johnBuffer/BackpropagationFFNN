...
public:
    ...
    [[nodiscard]]
    sf::Vector2f getScreenPosition(sf::Vector2f world_position) const
    {
        return m_viewport_handler.getScreenCoords(world_position);
    }
...
public:
    WindowContextHandler(const std::string& window_name,
        ...
        : m_window(sf::VideoMode(window_size.x, window_size.y), window_name, window_style, settings)
